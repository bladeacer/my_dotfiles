...
Item {
  ...
  // FULLSCREEN DISMISSAL: handled by LocalInlinePopup backdrop MouseArea
  // This MouseArea removed to avoid cursor-focus conflict on Wayland/KWin
  ...
  Rectangle {
    ...
    // FIXED: Horizontal alignment handled by root container, pinned to top
    ...
    ColumnLayout {
      ...
      ColumnLayout {
        ...
        Text {
          ...
          text: "CLICK ANY APP TO LAUNCH  ||  ESC+BACKDROP TO CLOSE"
          color: Theme.fgMuted
