...
PanelWindow {
    ...
    function scrubTo(percent) {
        ...
        // Safely update parameters and execute backend trigger mechanics
        cmdScrub.command = ["playerctl", "position", targetSec.toString()];
                ...
                ColumnLayout {
                    ...
                    Item {
                        ...
                        RowLayout {
                            ...
                            Text {
                                // FIX: Protect calculation loops from dividing against 1s fallbacks or broken tracks
                                text: {
