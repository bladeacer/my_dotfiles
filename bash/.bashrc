...
alias vf='find -type f | fzf --layout reverse --info inline --border --preview "bat --color=always --style=numbers,changes {}" --preview-window '~3' --bind "enter:execute(nvim {})"'
alias vg='rg --files -g "!node_modules/" | fzf --layout reverse --info inline --border --preview "bat --color=always --style=numbers,changes {}" --bind "enter:execute(nvim {})"'
...
alias ytd='yt-dlp --embed-thumbnail --embed-metadata --audio-format opus'
alias pacman-clear='sudo rm -r /var/cache/pacman/pkg/download-*'
alias tmux-td='~/my_dotfiles/tmux/theme-dev.sh'
alias todo='todo-or-else list ./'
alias update-grub="sudo grub-mkconfig -o /boot/grub/grub.cfg"
alias nuke-lazy='sudo rm -r ~/.local/share/nvim/lazy/'
